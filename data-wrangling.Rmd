...
incarceration_trends <- incarceration_trends %>%
  ...
  mutate(
    total_jail_prison_pop_rate = ifelse(
      is.na(total_jail_pop_rate), total_jail_prison_pop_rate = total_prison_pop_rate, ifelse(
      is.na(total_prison_pop_rate), total_jail_prison_pop_rate == total_jail_pop_rate, total_jail_prison_pop_rate = total_prison_pop_rate + total_jail_pop_rate
      )
    )
  )

...
```{r, eval = TRUE}
incarceration_populations
incarceration_time_animation <- ggplot() + 
  geom_line(data = incarceration_populations, aes(x = year, y = total_incarcerated)) +
  geom_line(data = incarceration_populations, aes(x = year, y = local_jail)) +
  geom_line(data = incarceration_populations, aes(x = year, y = state_prison)) +
  geom_line(data = incarceration_populations, aes(x = year, y = federal_prison)) 
+
  transition_reveal(year)
incarceration_time_animation
```
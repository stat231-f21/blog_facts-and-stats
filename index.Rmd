...
=======
The first tab of this shiny app is a bar graph meant to show the disparity in incarceration rates between Black, white, and Latinx ppeople. This shows much of the same information as the map of racial disparity above but visualizes the gaps in a way that is much clearer. As you will see by exploring the histogram, incarceration rates of Black people almost always double that of white people.

## Interactive Map
>>>>>>> 7663d95640a912281b1b71ac865dddfc037ae5f8
...
```{r map code, echo = TRUE}
# will include updated version
```

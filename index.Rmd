...
2007 is the peak of incarceration in America, and we can see that most of the counties have a rate of $1000 - 5000$ incarcerated per $100,000$. Whereas in 1970, most of the country has a rate of $0 - 250$. After the slight decline in incarceration rates, the 2018 map shows that most of the counties have a rate of $250 - 2500$ which is less severe than the state of 2007. However, one can also see that most of the counties that have the highest incarceration rates in America still maintain their extremely high rates — some even maintained their trend of increasing. For example, Madison County, Louisiana, has a prison & jail incarceration rate high of $10543.97$ in 2007, which increased dramatically from $64.39$ in 2000, and still remained at a horrifying $9227.41$ in 2018 (admist the national-wide decrease in incarceration rate). 

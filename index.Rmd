...
# Change in Incarceration Population Overtime

```{r, echo=FALSE, out.width = '75%'}
knitr::include_graphics("incarceration_time_series.gif")
```

This visualization shows the amount of people in the US in jails and prisons in the United States. The incarcerated population grew extremely fast between 1980 and 2007 from 500,000 to well over 2,000,000. Since then the incarcerated population has started to decrease but only slightly.
